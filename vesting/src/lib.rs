...
pub struct VestingSchedule<BlockNumber, Balance: HasCompact + MaxEncodedLen> {
...
impl<BlockNumber: AtLeast32Bit + Copy, Balance: AtLeast32Bit + Copy + MaxEncodedLen> VestingSchedule<BlockNumber, Balance> {
